              ...
              <div className="p-4 bg-white flex flex-col items-center justify-center py-10">
                <div className="text-center mb-4">
                  ...
                  <h2 className="text-xl font-medium text-gray-900 mb-2">
                    No Workshop Classes Found
                  </h2>
                  <p className="text-gray-500 max-w-md">
                    There are currently no active workshop classes scheduled.
                    New classes will appear here once they are added to the
                    system.
                  </p>
                </div>
              ...
              <div className="rounded-lg p-6 border-1 border-gray-400 mb-5">
                <div className="p-4 bg-white flex flex-col items-center justify-center py-10">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-gray-500 max-w-md">
                      There are no past workshop classes in your history.
