...
export default function Login({ value: setModalType }) {
  ...
  const handleGoogleLogin = () => {
    console.log("I am doing google login");
  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center">
        <div className="border-solid p-4 w-15/16 max-w-md">
          <h1 className="text-left text-xl font-bold ml-4 mt-1 mb-4">
            Sign In
          </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className={`btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl bg-amber-500
